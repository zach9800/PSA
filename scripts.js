// Load saved PSAs from localStorage
let psas = JSON.parse(localStorage.getItem('psas')) || [
    {
...
const colors = ["#ff6b6b", "#6bffb6", "#6b6bff", "#ffff6b", "#ff6bff"]; // Array of colors for borders
...
function savePSA(index) {
    ...
    localStorage.setItem('psas', JSON.stringify(psas));
